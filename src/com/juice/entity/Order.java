...
/*we can  have  cartlist in this class  so as to know  what  has to be delivery to each  customer
 * Mapping  of list  type  collection  with  MySQl  is easy  with Hibernate . since  we have 
 *  not  completed  Hibernet this part  needs  to be  done later ; after  the daus  hibernate portion  is done 
 */
...
public void setCustomerId(String cuatomerId) {
	this.customerId = cuatomerId;
}
